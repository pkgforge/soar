...
/// told apart.
///
/// The settings are described here too, so a frontend offering them does not
/// have to carry its own idea of what soar can be configured with. `profiles`
/// are the ones this machine has, which is why the description is generated
...
output = {{ format = "json", select = "$.items[*]" }}
fields = {{ name = "name", family = "family", version = "version", repo = "repo", description = "description", size = "size", checksum = "checksum", homepage = "homepages", license = "licenses", category = "categories", notes = "notes", build_date = "build_date", download_url = "download_url" }}
